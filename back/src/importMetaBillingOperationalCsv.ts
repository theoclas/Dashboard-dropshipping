...
import { upsertOperationalExpenseFromBilling, billingImportDedupeKey } from "./operationalExpenseBillingUpsert";
...
async function upsertExpenseFromBillingRow(
  ...
  return upsertOperationalExpenseFromBilling(
    companyId,
    createdByUserId,
    metaId,
    businessName,
